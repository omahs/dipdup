...
MatchedEventsT = tuple[BlockscoutEventsHandlerConfig, BlockscoutEvent[Any]]
...
def prepare_event_handler_args(
    ...
    matched_event: BlockscoutEventData | EvmNodeLogData,
) -> BlockscoutEvent[Any]:
...
def match_events(
    package: DipDupPackage,
    handlers: Iterable[BlockscoutEventsHandlerConfig],
    events: Iterable[BlockscoutEventData | EvmNodeLogData],
