...
from dipdup.config.evm_blockscout_transactions import BlockscoutTransactionsHandlerConfig
from dipdup.exceptions import FrameworkException
from dipdup.indexes.evm_blockscout import get_sighash
from dipdup.models.evm_node import EvmNodeTransactionData
from dipdup.models.evm_blockscout import BlockscoutTransaction
...
MatchedTransactionsT = tuple[
    BlockscoutTransactionsHandlerConfig, BlockscoutTransaction[Any] | BlockscoutTransactionData | EvmNodeTransactionData
]


# NOTE: Completely disable padding validation. If data is in Blockscout, node was ok with it.
...
def prepare_transaction_handler_args(
    ...
    handler_config: BlockscoutTransactionsHandlerConfig,
    matched_transaction: BlockscoutTransactionData | EvmNodeTransactionData,
) -> BlockscoutTransaction[Any]:
...
def match_transactions(
    package: DipDupPackage,
    handlers: Iterable[BlockscoutTransactionsHandlerConfig],
    transactions: Iterable[BlockscoutTransactionData | EvmNodeTransactionData],
