...
from dipdup.indexes.evm_blockscout_transactions.fetcher import TransactionFetcher
from dipdup.indexes.evm_blockscout_transactions.matcher import match_transactions
...
class BlockscoutTransactionsIndex(
    BlockscoutIndex[BlockscoutTransactionsIndexConfig, tuple[EvmNodeTransactionData, ...], BlockscoutDatasource],
    message_type=BlockscoutMessageType.transactions,
):
    ...
    async def _call_matched_handler(
        ...
        transaction: BlockscoutTransaction[Any],
    ) -> None:
